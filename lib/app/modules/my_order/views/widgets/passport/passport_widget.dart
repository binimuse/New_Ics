...
import 'package:new_ics/app/modules/my_order/views/widgets/passport/detail_page_passport.dart';
...
class PassportWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: Padding(
        ...
        child: Column(
          children: [SizedBox(height: 1.h), buildCard(icsApplication)],
        ),
      ),
    );
  }
  ...
  Widget buildCard(IcsApplication icsApplication) {
    return GestureDetector(
      onTap: () {
        ...
        Get.to(DetailPassportWidget(icsApplication: icsApplication));
      },
      child: Container(
        height: 23.5.h,
  ...
  String getApplicationame(IcsApplication orginApplication) {
    if (orginApplication.applicationType == "NEW_PASSPORT_APPLICATION") {
      return "New Passport Application".tr;
    } else if (orginApplication.applicationType ==
        "RENEW_PASSPORT_APPLICATION") {
      return "ReNew Passport Application".tr;
    } else {
      return "";
    }
  }
