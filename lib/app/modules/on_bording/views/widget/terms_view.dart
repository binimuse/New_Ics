...
import 'package:new_ics/app/common/button/app_icon_button.dart';
import 'package:new_ics/app/common/button/button_primary_fill.dart';
import 'package:new_ics/app/common/button/check_box.dart';
import 'package:new_ics/app/common/navigation/top_nav_back_icon.dart';
import 'package:new_ics/app/data/enums.dart';
import 'package:new_ics/app/modules/signup/controllers/signup_controller.dart';
  ...
  void toggleTerm(int index) {
    setState(() {
      ...
      if (!termCheckboxes[index].value) {
        ...
        allTermsChecked.value = termCheckboxes.every(
                          ...
                          Row(
                            children: [
                              ...
                              MyCheckBox(
                                ...
                                text: "I agree with all terms".tr,
                              ),
                            ],
                          ),
                          Padding(
                            ...
                            Row(
                              children: [
                                MyCheckBox(
                                  ...
                                  text:
                                      index == 0
                                          ? "I agree with the Terms of Use".tr
                                ...
                                AppSvgButton(
                                  ...
                                  onPressed: () {
                                    // Navigate to the respective terms page
                                    // based on the index of the term checkbox
                                    if (index == 0) {
                                      // Get.toNamed(
                    ...
                    child: ButtonPrimaryFill(
                      ...
                      onTap: () {
                        if (allTermsChecked.value) {
                          ...
                          AppToasts.showError("All Terms are not Checked".tr);
                        }
                      },
                    ),
                  ),
