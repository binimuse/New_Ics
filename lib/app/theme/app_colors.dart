...
class AppColors {
  ...
  //PRIMARY
  static Color primary = const Color(0xff004EAD);
  static Color primaryLighter =
      const Color.fromARGB(255, 88, 123, 167).withOpacity(0.1);
  static Color primaryLight =
      const Color.fromARGB(255, 33, 82, 141).withOpacity(0.3);
  static Color primaryDark = const Color.fromARGB(255, 0, 104, 231);

  //PRIMARY
  static Color secondary = Color.fromARGB(255, 235, 35, 35);
  static Color secondaryDark = Color.fromARGB(255, 69, 3, 3);
  static Color secondaryLight = Color.fromARGB(255, 231, 75, 75);
  static Color secondaryLighter = Color.fromARGB(255, 237, 144, 144);
